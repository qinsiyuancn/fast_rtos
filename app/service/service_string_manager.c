...
typedef int (*out_service)(const char * msg, char * ret, unsigned int size);
 ...
 *
 */
int request_service(unsigned long fd, const char *msg, char* ret, unsigned int size)
{
 ...
 *
 */
int request_service_duty(char * msg, char * ret, unsigned int size)
{
    unsigned long i = 0;
