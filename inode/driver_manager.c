...
int driver_open(unsigned int driver,  unsigned int dev)
{
    if(list[driver].open)
...
int driver_read(unsigned int driver, unsigned int dev, void *buffer, unsigned long size)
{
    if(list[driver].open)
...
int driver_close(unsigned int driver, unsigned int dev)
{
